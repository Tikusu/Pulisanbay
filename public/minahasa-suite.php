      ...
      <div class="split-section">
        <div class="reveal"><span class="section-label">What's Included</span>
          ...
          <button class="btn-more-amenities" id="toggleAmenitiesMinahasa"
            onclick="toggleAmenities('moreAmenitiesMinahasa','toggleAmenitiesMinahasa')">
        ...
        <div class="reveal" style="padding:2.5rem;background:var(--earthy-sand);">
          ...
          <ul style="color:var(--slate);font-size:0.9rem;line-height:2;list-style:none;">
            ...
            <li style="margin-top:1rem;"><a href="terms-and-conditions.php"
                style="color:var(--savanna-gold);text-decoration:none;font-weight:600;font-size:0.85rem;">View Full
